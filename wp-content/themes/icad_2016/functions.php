...
{
    wp_register_style('icadcss', get_template_directory_uri() . '/style.css', array(), '1.0', 'all');
    wp_enqueue_style('icadcss'); // Enqueue it!
}
...
function wpb_list_child_pages() { 
	...
	if (is_page() && $post->post_parent) {	
		$parents = wp_get_post_parent_id( $post->post_parent );
		$childpages = wp_list_pages( 'sort_column=menu_order&title_li=&child_of=' . $parents . '&echo=0' );
	} else {
